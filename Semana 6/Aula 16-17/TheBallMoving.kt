...
operator fun Position.plus(offset: OffsetVector)
    = Position(this.x + offset.dx, this.y + offset.dy)
// operator - overload
operator fun Position.minus(offset: OffsetVector)
    = Position(this.x - offset.dx, this.y - offset.dy)
...
fun main() {   // () -> Unit
    ...
    onStart( fx = {
        ///////////////////////////////////////////////////////////////
//        val position1: Position = Position(3, 10)
//        val offsetVec: OffsetVector = OffsetVector(-DELTA, 0)
//        val resPosition = position1.plus(offsetVec) // (2, 10) if DELTA == 1
//        val resPosition1 = position1 + offsetVec // (2, 10), equal to plus
//        println(resPosition)
//        println(resPosition1)
